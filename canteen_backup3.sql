...
('pbkdf2_sha256$600000$KebfPYm7urGtTNcjLJzasW$Br/5yEyQg70cwhwRaCoOZERSx+akojeaLQ/QK2PLgog=',0,'herve','Herve','Kamga',0,1,'542a1848-e278-48fd-afa5-470669646751','herve@oapi.int','','employee','active','emplo001','IT','',0.00,'wallet','2025-09-07 19:55:44.194068','2025-09-24 22:50:29.364251','2025-09-07 19:55:44.194148',0,'','',NULL,'2025-09-24 22:50:29.470528',48,0,NULL),
...
(36,'notifications','0006_remove_notification_action_text_and_more','2025-09-23 18:11:51.148947'),
(37,'notifications','0007_remove_notification_action_text_and_more','2025-09-23 18:11:51.302446'),
(38,'notifications','0003_sync_with_current_state','2025-09-24 22:42:33.076642'),
(39,'payments','0002_alter_payment_payment_method_and_more','2025-09-24 22:58:24.649376');
...
CREATE TABLE `notifications_notification` (
  ...
  KEY `notificatio_target__eb1b7a_idx` (`target_user_id`,`created_at` DESC),
  CONSTRAINT `fk_notification_target_user` FOREIGN KEY (`target_user_id`) REFERENCES `auth_user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('84f8736e-e28b-47e2-9d50-bc05280b548f','Test Notification','This is a test','system_announcement','2025-09-23 16:46:41',0,NULL,'','','normal',NULL,'specific_user');
...
CREATE TABLE `payments_payment` (
  ...
  KEY `payments_pa_payment_87c4c1_idx` (`payment_reference`),
...
(201,'login','User logged in successfully','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:140.0) Gecko/20100101 Firefox/140.0','2025-09-24 09:21:18.828571','{}','542a1848-e278-48fd-afa5-470669646751'),
(202,'logout','User logged out','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:140.0) Gecko/20100101 Firefox/140.0','2025-09-24 22:50:03.130284','{}','542a1848-e278-48fd-afa5-470669646751'),
(203,'login','User logged in successfully','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:140.0) Gecko/20100101 Firefox/140.0','2025-09-24 22:50:29.528367','{}','542a1848-e278-48fd-afa5-470669646751');
...
-- Dump completed on 2025-09-25  9:29:22
